...
<div class="super_container">
	...
	<div class="home">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="images/mainimages/services.jpg" data-speed="0.8"></div>
		<div class="home_container">
			<div class="container">
				<div class="row">
					<div class="col">
						<div class="home_content text-center">
							<div class="home_title"><h1><font style="font-size: 85px">Recently View</font></h1></div>
			...
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						<div class="section_title"><h1>Recently Viewed HOTEL</h1></div>
						<div class="section_text">
						최근 어떤 상품을 클릭했는지 모르겠다구요? 걱정하지 마세요! 현재 페이지에서 당신의 조회 상품 리스트를 가지고 와줍니다.
						</div>
					</div>
				</div>
			</div>
	...
	<div class="rooms">
		<div class="container">
			<div class="row rooms_row">
				...
				<c:choose>
				<c:when test="${!empty recentlyHotel}">
				<c:forEach items="${recentlyHotel}" var="recently">  
				<div class="col-lg-4">
					<div class="rooms_item">
						<div class="rooms_image"><img src="images/hotelimages/${recently.getHotel_main_image()}" width="360px" height="295px" alt="https://unsplash.com/@yuni_ladyday2"></div>
						<div class="rooms_title_container text-center">
							<div class="rooms_title">
							<h1>${fn:split(recently.getHotel_name(),'(')[0]}</h1>
							<h4>(${fn:split(recently.getHotel_name(),'(')[1]}</h4>
							</div>
						</div>
						<div class="rooms_list">
							<ul>
								...
								<li class="d-flex flex-row align-items-start justify-content-start">
									<div>
									<b>information</b><br>
									${fn:substring(recently.getHotel_instroduct(),0,250)}....
									</div>
								</li>
						<br>
						<hr>		
								<li class="d-flex flex-row align-items-start justify-content-start">
									...
									<div>${recently.getHotel_tel()}</div>
								</li>
						<br>	
						<hr>
						<!-- 편의 시설 루프 -->	
						<c:choose>
						<c:when test="${!empty recentlyFacility}">
						<c:forEach items="${recentlyFacility}" var="recentlyF"> 
						<c:if test="${recently.getHotel_no() eq recentlyF.getHotel_no()}"> 
								<li class="d-flex flex-row align-items-start justify-content-start">
									<div><div>Convenient Facilities#:</div></div>
									<div>${recentlyF.getHotel_option_title()}</div>
								</li>
						</c:if>
						</c:forEach>
						</c:when>
						<c:otherwise>등록된 편의 시설이 없습니다.</c:otherwise>
								...
								<li class="d-flex flex-row align-items-start justify-content-start">
									...
									<!-- 1성일때  -->
									<c:if test="${recently.getHotel_class() eq 1}">
									<div><img src="images/starimages/star_image.png" width="20px" height="20px"></div>
									</c:if>

									<!-- 2성일때  -->
									<c:if test="${recently.getHotel_class() eq 2}">
									<div><img src="images/starimages/star_image.png" width="20px" height="20px">
									<img src="images/starimage/sstar_image.png" width="20px" height="20px"></div>
									</c:if>
									
									<!-- 3성일때  -->
									<c:if test="${recently.getHotel_class() eq 3}">
									<div><img src="images/starimages/star_image.png" width="20px" height="20px">
									...
									<!-- 4성일때  -->
									<c:if test="${recently.getHotel_class() eq 4}">
									<div><img src="images/starimages/star_image.png" width="20px" height="20px">
									<img src="images/starimages/star_image.png" width="20px" height="20px">
									<img src="images/starimages/star_image.png" width="20px" height="20px">
									<img src="images/starimages/star_image.png" width="20px" height="20px"></div>
									...
									<!-- 5성일때  -->
									<c:if test="${recently.getHotel_class() eq 5}">
									<div><img src="images/starimages/star_image.png" width="20px" height="20px">
									<img src="images/starimages/star_image.png" width="20px" height="20px">
									<img src="images/starimages/star_image.png" width="20px" height="20px">
									<img src="images/starimages/star_image.png" width="20px" height="20px">
						...
						<input type="hidden" name="hotel_no" value="${recently.getHotel_no()}">
