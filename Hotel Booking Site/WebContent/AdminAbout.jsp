...
<link rel="stylesheet" type="text/css" href="styles/contact_responsive.css">
  ...
  <!-- 데이트피커 -->
   ...
   <script>
   function imageForm(){
   	if(document.imageForms.checkImage.value == false){
			...
			<div class="row">
				...
				<div class="col-lg-5">
					<div class="contact_content">
						...
						<form action="./ChangeAdminInfor.ad" method="post">
							<p><textarea rows="6" cols="55" placeholder="${aboutInfor.getAdmin_infor()}" name="admin_infor"></textarea></p>
							<div align="right"><input class="buttonT" type="submit" value="정보 변경" style="width:120px; height:60px"></div>
						</form>
						</div>
						<div class="contact_section_info">
						<form action="./ChangeAdminInfors.ad" method="post">
							<ul>
								<li class="d-flex flex-row align-items-center justify-content-start">
									...
									<div><font style="font-size: 14px"><input type="text" name="admin_address" placeholder="${aboutInfor.getAdmin_address()}" style="width: 300px;"></font></div>
								</li>
								<li class="d-flex flex-row align-items-center justify-content-start">
									...
									<div><input type="text" name="admin_tel" placeholder="${aboutInfor.getAdmin_tel()}" style="width: 300px"></div>
								</li>
								<li class="d-flex flex-row align-items-center justify-content-start">
									...
									<div><input type="text" name="admin_email" placeholder="${aboutInfor.getAdmin_email()}" style="width: 300px"></div>
								</li>
							</ul>
							<div align="right"><input class="buttonT" type="submit" value="정보 변경" style="width:100px; height:60px"></div>
						</form>
						</div>
					</div>
				</div>
				...
				<form action="./ChangeAdminImage.ad" method="post" enctype="multipart/form-data" name="imageForms" onsubmit="return imageForm()">
					<div class="contact_image"><img src="images/mainimages/${aboutInfor.getAdmin_image()}" style="border-radius: 10px 0 10px 0; height: 510px; width: 650px" alt="https://unsplash.com/@gabrielghnassia"></div>
					<div align="right">
					<table><tr><td>
					<div><input class="buttonT" name="admin_image" id="checkImage" style="width:100%" type="file" value="이미지 선택">
					</td><td><input class="buttonT" style="width:100%" type="submit" value="이미지 변경"></td>
					</tr></table></div>
				</form>
				</div>
			</div>
						...
						<div class="contact_info_box d-flex flex-column align-items-center justify-content-center" style="width: 240px;height: 260px">
							<ul class="contact_info_list">
								...
								<li class="d-flex flex-row align-items-center justify-content-start">
									...
									<div class="contact_info_text">+86-010-2661-1538</div>
								</li>
								<li class="d-flex flex-row align-items-center justify-content-start">
									...
									<div class="contact_info_text">sir91@naver.com</div>
								</li>
							</ul>
						</div>
